  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AydinKadinDogumRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AydinKadinDogumRecord> rehberAydinKadinDogumRecordList =
            snapshot.data;
        // Customize what your widget looks like with no query results.
        if (snapshot.data.isEmpty) {
          // return Container();
          // For now, we'll just include some dummy data.
          rehberAydinKadinDogumRecordList =
              createDummyAydinKadinDogumRecord(count: 1);
        }
        final rehberAydinKadinDogumRecord =
            rehberAydinKadinDogumRecordList.first;
        return Scaffold(
          key: scaffoldKey,
              ...
              Expanded(
                child: StreamBuilder<List<AydinKadinDogumRecord>>(
                  stream: queryAydinKadinDogumRecord(
                    queryBuilder: (aydinKadinDogumRecord) =>
                        aydinKadinDogumRecord.where('isim',
                            isLessThanOrEqualTo: textController.text),
                  ),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    if (!snapshot.hasData) {
                                    ...
                                    children: [
                                      StreamBuilder<
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<AydinKadinDogumRecord>
                                              imageAydinKadinDogumRecordList =
                                              snapshot.data;
                                          // Customize what your widget looks like with no query results.
                                          if (snapshot.data.isEmpty) {
                                            // return Container();
                                          ...
                                          final imageAydinKadinDogumRecord =
                                              imageAydinKadinDogumRecordList
                                                  .first;
                                          return Padding(
                                            padding:
                                    ...
                                    children: [
                                      Expanded(
                                        child: StreamBuilder<
                                            AydinKadinDogumRecord>(
                                          stream:
                                              AydinKadinDogumRecord.getDocument(
